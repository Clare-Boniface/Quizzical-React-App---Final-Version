...
export default function Questions({ questions, handleAnswerClick, selectedAnswers, handleCheckAnswers }) {
    return (
        <div>
                    ...
                    <div key={question.question}>
                        ...
                        <div className="answers">
                            {question.answers.map((answer, index) => (
                                <p key={index} className={`flex answer ${selectedAnswers[questionIndex] === answer ? "selected-answer" : ""}`} onClick={() => handleAnswerClick(questionIndex, answer)}>
                                    {he.decode(answer)}
                                </p>
                            ))}
                        </div>
            ...
            <button className="button check-answers-btn" onClick={handleCheckAnswers}>
                Check answers
            </button>
        </div>
    );
